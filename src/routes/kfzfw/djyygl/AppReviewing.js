...
import styles from './AppReviewing.less'
...
export default class AppReviewing extends  Component{
    constructor(props){
        super(props)
        this.state = {
    ...
    handerTableCoulm =(culcolumns) => {
        ...
        let  htmlaction = {
            ...
            render: (text, record) => (
              ...
              onClick={this.props.addCompant.bind(this,{id:record.id,url:'/console/djyyxq',titel:'应用详情',param:{row:record}})}
              >应用详情</a></div>
            )
