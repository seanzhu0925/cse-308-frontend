...
import AppInterfaceInfo from './AppInterfaceInfo'
...
const ButtonGroup = Button.Group;
  ...
  {
    title: '接口调用成功次数',
    dataIndex: 'requestsecesscount',
    key: 'requestsecesscount',
  },
  {
    title: '接口调用成功次数',
    dataIndex: 'requestfalsecount',
    key: 'requestfalsecount',
  },
]
...
export default class AppHistoryPageDetailFristpage extends  Component{
    constructor(props){
        super(props)
        this.state = {
            starttime:'',
